...
**Generated structure**: `skillset.yaml` (manifest with batch_id), `content/README.md`, `content/QUICKSTART.md`, `content/INSTALL_NOTES.md` (only if not already detected).
