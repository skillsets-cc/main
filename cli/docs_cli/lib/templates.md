...
| `QUICKSTART_TEMPLATE` | string | Template for QUICKSTART_<NAME>.md installation guide |
| `INSTALL_NOTES_TEMPLATE` | string | Template for content/INSTALL_NOTES_<NAME>.md pre-install notes |
