...
## Integration Points
- **Used by**:
  - All pages (index, about, contribute, privacy, skillset detail, 404)
- **Consumes**:
...
- 7 nav links: Registry (/), Contribute (/contribute), About (/about), Privacy (/privacy), GitHub, Reddit, Email
