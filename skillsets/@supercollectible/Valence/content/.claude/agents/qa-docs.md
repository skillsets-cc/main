...
- **activeForm**: Mapping module structure
- **description**: Build a manifest of implementation files and their expected doc paths:
...
- **activeForm**: Processing file pairs
- **description**: For EACH pair in the manifest, execute this closed loop:
...
- **activeForm**: Updating module docs
- **description**: After all pairs processed:
