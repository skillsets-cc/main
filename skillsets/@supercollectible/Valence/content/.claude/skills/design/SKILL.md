...
| Scope | Check |
|-------|-------|
| System-level | `ARCHITECTURE_backend.md` or `ARCHITECTURE_frontend.md` |
| Module-level | `README_*.md` (backend) or `docs_*/ARC_*.md` (frontend) |
| Component-level | Per-file docs in `docs_*/` directories |
| Patterns | `frontend_styleguide.md` or `backend_styleguide.md` |
